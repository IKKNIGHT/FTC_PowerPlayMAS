...
public class BlueRightAutonomous extends LinearOpMode {
    ...
    public static int coneTop = -775; //prev
    ...
    public static int low = -1150;  //prev -1000
    public static int medium = -2150; //prev -2000
    public static int high = -2800;

    //SHOULDER
    public static double inward = 0.11;
    public static double scoreArm = 0.31; //prev 0.325 THIS CAN BE ADJUSTED
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Pose2d startPose = new Pose2d(-48+length +4, 48+width +8, startHeading); //starting position  //ADJUST THIS
        drive.setPoseEstimate(startPose);

        //PRELOAD SCORE + GOTO CONE STACK
        TrajectorySequence conePreload = drive.trajectorySequenceBuilder(startPose)
                .strafeTo(new Vector2d(-48+length + 1.5, 21)) //move to low pole //THIS CAN BE ADJUSTED
                ...
                .splineToConstantHeading(new Vector2d(-66, 14), startHeading) //go to cone stack
